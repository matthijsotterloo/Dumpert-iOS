...
class Video {
    ...
    var brief: String
    var date: String
    var videoLinkLow: String
    var videoLink: String
    var tags = [String]()
    var views: Int
    var kudos: Int
    
    init(id: String, thumb: UIImage, title: String, brief: String, date: String, videoLinkLow: String, videoLink: String, tags: String, views: Int, kudos: Int){
        self.id = id
        self.thumb = thumb
        self.title = title
        self.brief = brief
